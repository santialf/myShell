...
MATRIX_DIR="/global/D1/homes/santiago/reorderings/gorder2/"
...
for input_matrix in "${INPUT_MATRICES[@]}"; do
    ...
    srun ncu -o "reports/report_spmm_1D_gorder_$base_filename" -k spmm_1D -c 1 --set full ./row_per_thread "/work/santiago/tmp7/$base_filename"
