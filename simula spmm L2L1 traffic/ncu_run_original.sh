...
for input_matrix in "${INPUT_MATRICES[@]}"; do
    ...
    srun ncu -k load_balancing_kernel -c 1 --metrics l1tex__m_xbar2l1tex_read_bytes.sum,l1tex__m_l1tex2xbar_write_bytes.sum ./spmm_csr_example "/work/santiago/tmp/$base_filename"
