...
for input_matrix in "${INPUT_MATRICES[@]}"; do
    ...
    srun ncu -k spmv_1D -c 1 --metrics l1tex__m_xbar2l1tex_read_bytes.sum,l1tex__m_l1tex2xbar_write_bytes.sum ./rows_per_thread  "/work/santiago/tmp2/$base_filename"
