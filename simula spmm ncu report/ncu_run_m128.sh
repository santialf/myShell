...
"GAP/GAP-road.mtx.gz"
"GenBank/kmer_P1a.mtx.gz"
"Gleich/wb-edu.mtx.gz"
"Janna/Queen_4147.mtx.gz"
"LAW/uk-2005.mtx.gz"
"MAWI/mawi_201512020130.mtx.gz"
...
for input_matrix in "${INPUT_MATRICES[@]}"; do
    ...
    srun ncu -o "reports/report_spmm_32_m128_$base_filename" -k load_balancing_kernel -c 1 --set full ./spmm_csr_example "/work/santiago/tmp5/$base_filename"
